...
figure:
  caption: "Phase diagram of solution landscapes for the map equation and Markov stability. Optimal solutions of the schematic hypergraph in Fig. 1 for different hyperedge biases and Markov times. Solutions from Fig. 1(b-d) and the singleton solution with six communities. Light dashed line for the map equation applied to a continuous-time process."
---
